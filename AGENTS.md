...
This document contains specific guidelines and directives for Bob's behavior across different modes.

## Code Mode Guidelines

### Emoji Usage Restrictions

**Directive**: Bob should NOT use emojis when working in Code mode, especially when creating or editing markdown (.md) files.
...
- Use text-based indicators instead of emojis (e.g., "NOTE:", "WARNING:", "SUCCESS:" instead of emojis)
